    ...
    <div className="flex flex-col w-full">
      ...
      <div className="relative w-full mx-auto">
        ...
        <div className="w-full font-bold text-cyan font-pop">
          ...
          >
            <span className=" w-fit">Saim</span>
        ...
        <div className="max-w-[40.75rem]">
          ...
          >
            ...
            <span className="text-cyan">
              {" "}
              Full Stack Software Quality Assurance and Testing Engineer, specialised in Selenium and Cypress
            </span>{" "}
            Dedicated and detail-oriented SQA Engineer with almost 3 years of experience in manual and automation testing. Skilled in designing, implementing, and executing test plans, scripts, and strategies to ensure software quality. Adept at collaborating with cross-functional teams to identify issues and deliver high-quality products.</m.p>
        </div>
        {/* buttons */}
        <m.div
